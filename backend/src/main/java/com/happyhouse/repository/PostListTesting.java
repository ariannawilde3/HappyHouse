...
public class PostListTesting {
    ...
    private List<Post> posts = new ArrayList<Post>(Arrays.asList(
		new Post(1, "I can't believe this",
			...
			5,
			new ArrayList<String>(Arrays.asList("Legal", "Safety", "Landlord")),
			new ArrayList<Comment>(Arrays.asList(new Comment(1, "You will get absolutely no help with this. Good luck.")))),
		new Post(2,
			"HELP ME!",
			...
			200,
			new ArrayList<String>(Arrays.asList("Legal", "Most Popular")),
			new ArrayList<Comment>(Arrays.asList(new Comment(1, "whatever")))),
		new Post(3, "My roommate is allergic to peanuts. Why?",
			...
			927, new ArrayList<String>(0), new ArrayList<Comment>(Arrays.asList(
    ...
    public Post getById(int id) {
		...
		return new Post(0, "not found", "not found", new ArrayList<String>(0));
    }
}